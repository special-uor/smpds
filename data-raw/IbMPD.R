...
IbMPD_taxa_counts_amalgamation_rev <-
  IbMPD_taxa_counts_amalgamation %>%
...
waldo::compare(IbMPD_taxa_counts_amalgamation,
               IbMPD_taxa_counts_amalgamation_rev)
waldo::compare(IbMPD_taxa_counts_amalgamation %>%
...
IbMPD_taxa_counts_amalgamation <- IbMPD_taxa_counts_amalgamation_rev
...
climate_reconstructions <-
  "data-raw/reconstructions/IbMPD_climate_reconstructions_2022-05-12.csv" %>%
  readr::read_csv()

# Load daily values for precipitation to compute MAP (mean annual precipitation)
climate_reconstructions_pre <-
  "data-raw/reconstructions/IbMPD_climate_reconstructions_pre_2022-05-12.csv" %>%
  readr::read_csv() %>%
  dplyr::rowwise() %>%
...
usethis::use_data(IbMPD, overwrite = TRUE, compress = "xz")
waldo::compare(smpds::IbMPD, IbMPD, max_diffs = Inf)
